...
user_name = 'Плышевская Кристина'
user_email = 'test@test.com'
current_address = 'г. Тест, ул. Тест, д. 67, кв. 69'
permanent_address = 'г. Тест, ул. Тест, д. 67, кв. 69'
...
# driver.find_element(By.XPATH, '//div[@class="rc-tree-switcher rc-tree-switcher_close rc-tree-treenode rc-tree-treenode-switcher-close rc-tree-treenode-leaf-last"]//span[@class="rc-tree-indent"]')
# driver.find_element(By.XPATH, '')
# driver.find_element(By.ID, '//span[@aria-label="Select Notes"]').click()
...
action = ActionChains
action.driver.find_element(By.ID, 'doubleClickBtn')
time.sleep(2)
action.driver.find_element(By.ID, 'rightClickBtn')
time.sleep(2)
jq2ll = action.driver.find_element(By.ID, 'jq2ll')
