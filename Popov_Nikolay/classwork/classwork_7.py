...
time.sleep(1)
button_1 = driver.find_element(By.XPATH, '//button[@id="doubleClickBtn"]')
actions.double_click(button_1).perform()
time.sleep(1)
button_2 = driver.find_element(By.XPATH, '//button[@id="rightClickBtn"]')
actions.context_click(button_2).perform()
time.sleep(1)
button_3 = driver.find_element(By.XPATH, '//button[text()="Click Me"]')
actions.click(button_3)
